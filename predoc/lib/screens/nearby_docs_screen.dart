...
class _NearbyDocsScreenState extends State<NearbyDocsScreen> {
  ...
  Future<void> _fetchLocationName(double lat, double lng) async {
    try {
      ...
      final resp =
          await http.get(url, headers: {'User-Agent': 'PredocApp/1.0'});
      if (resp.statusCode == 200) {
        ...
        if (address != null) {
          ...
          if (city != null && mounted) {
            setState(() => _locationName = city.toString());
          }
        }
      }
    } catch (_) {}
...
''';
    ...
    if (resp.statusCode != 200) {
      if (resp.statusCode == 429) {
        throw 'OSM server busy. Please wait a moment.';
      }
    ...
    for (final e in elements) {
      ...
      results.add(_NearbyDoctor(
        ...
        distanceKm:
            _haversineKm(lat, lng, (eLat).toDouble(), (eLng).toDouble()),
        openNow: false,
      ));
    }
  ...
  Future<void> _openNavigation(_NearbyDoctor doc) async {
    final geo = Uri.parse(
        'geo:${doc.lat},${doc.lng}?q=${Uri.encodeComponent(doc.name)}');
  ...
  Widget _buildLanding() {
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        const Text(
          'Predoc will use your GPS to find doctors & hospitals '
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text('Getting your location…',
              style: TextStyle(
                  ...
                  color: AppColors.textDark)),
          SizedBox(height: 6),
          Text('Then searching for doctors nearby',
              style: TextStyle(
                  fontFamily: 'Nunito',
                  fontSize: 12,
                  fontWeight: FontWeight.w600,
          ...
          Row(children: [
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                const SizedBox(width: 4),
                Text(_distLabel(doc.distanceKm),
                    style: const TextStyle(
                        fontFamily: 'Nunito',
                        fontSize: 11,
                        fontWeight: FontWeight.w800,
