// SettingsScreen — Day 8
//
// Provides the "Live Health Monitoring" toggle which starts/stops
// ContinuousAudioForegroundService.
//
// PERMISSION FLOW:
//   When the user first enables monitoring, we show a clear explanation
//   of what the microphone is used for before starting.
//
// SAFETY:
//   ✓ User can disable at any time
//   ✓ Explanation shown before enabling
...
class _SettingsScreenState extends State<SettingsScreen> {
  // Shared singletons — same instances as HomeScreen so they
  // communicate via the same mic stream and event bus.
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildInfoTile(
            ...
            subtitle: 'No audio, health data, or personal info is ever uploaded.',
          ),
          const SizedBox(height: 10),
          _buildInfoTile(
            icon: Icons.mic_off_rounded,
            title: 'No audio recordings',
            subtitle: 'Live monitoring only stores event counts — never raw audio.',
          ),
          const SizedBox(height: 10),
          _buildInfoTile(
